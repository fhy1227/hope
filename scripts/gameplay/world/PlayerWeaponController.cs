...
public partial class PlayerWeaponController : Node2D
{
	...
	private Node2D ResolveProjectileContainer()
	{
		...
		var projectiles = Combat.Instance?.World.Projectiles;
		if (projectiles != null)
		{
			return projectiles;
		}

		GD.PushError("PlayerWeaponController: Projectiles container not found. Set ProjectileContainerPath or ensure Combat scene is loaded.");
		return _owner;
	}
}
